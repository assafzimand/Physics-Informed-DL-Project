#!/usr/bin/env python3
"""
CV Full Analysis Script - T=250
Generates academic-quality plots for 5-fold cross-validation results for T=250 dataset.
...
class CVFullAnalyzer:
    ...
    def _load_cv_results(self):
        ...
        for line in lines:
            if "Distance Error:" in line:
                # Extract: "Distance Error: 1.702 ± 0.209 px"
                ...
                # Extract: "Validation Loss: 2.1421 ± 0.4872"
                parts = line.split(":")[-1].strip()
                # Handle both ± and other encodings
                if "±" in parts:
                    mean_std = parts.split("±")
                ...
                # Parse list: [1.4392441786252534, 1.4802589141405547, ...]
    ...
    def plot_1_cv_results_summary(self):
        ...
        ax1.set_title('5-Fold Cross-Validation: Distance Error (T=250)', fontweight='bold')
        ...
        ax2.set_title('5-Fold Cross-Validation: Validation Loss (T=250)', fontweight='bold')
        ...
        # Overall title
        fig.suptitle('T=250 Dataset: 5-Fold Cross-Validation Results Summary\n' + 
    ...
    def plot_2_statistical_significance(self):
        ...
        dataset_path = project_root / "data" / "wave_dataset_T250.h5"
        ...
        ax2.set_title('Error Distribution - Box Plot (T=250)', fontweight='bold')
...
Samples: {len(individual_errors)}"""
        ...
        ax3.set_title('Q-Q Plot - Normality Check (T=250)', fontweight='bold')
        ...
        ax4.set_title('Confidence Intervals (T=250)', fontweight='bold')
        ax4.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
        ax4.grid(True, alpha=0.3)
        
        # Overall title
        fig.suptitle(f'T=250 Dataset: Statistical Significance Analysis - Best Model (Fold {best_fold_idx + 1})\n' +
    ...
    def _find_best_model(self, fold_num):
        ...
        # Try different naming patterns for T=250 models
        patterns = [
            f"fold_{fold_num}_model.pt",
            f"t250_cv_full_fold_{fold_num}_best.pth",
            f"cv_full_5fold_75epochs_fold_{fold_num}_best.pth"
        ]
        ...
        print(f"❌ Could not find model file for fold {fold_num}")
        return None
    ...
    def plot_3_training_curves(self):
        ...
        ax1.set_title('Training & Validation Loss - All Folds (T=250)', fontweight='bold')
        ...
        ax2.set_title('Training & Validation Distance Error - All Folds (T=250)', fontweight='bold')
        ...
        ax3.set_title('Final Convergence Values (T=250)', fontweight='bold')
        ...
        table.scale(1.2, 1.5)
        ax4.set_title('Training Stability Analysis (T=250)', fontweight='bold', pad=20)
        
        # Overall title
        fig.suptitle('T=250 Dataset: 5-Fold Cross-Validation Training Analysis\n' +
    ...
    def generate_all_plots(self):
        ...
        print("🚀 Starting CV Full Analysis for T=250 - Generating 3 Essential Plots...")
        print("=" * 60)
        ...
        try:
            ...
            print("=" * 60)
            print("🎉 All T=250 CV Full analysis plots generated successfully!")
...
def main():
    """Main function to run CV full analysis for T=250."""
    # Path to T=250 CV full experiment
    cv_full_path = Path("experiments/t250_cv_full")
    
    if not cv_full_path.exists():
        print("❌ T=250 CV full experiment directory not found!")
        return
