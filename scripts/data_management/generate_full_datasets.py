...
def print_dataset_summary(wave_fields, source_coords, timesteps, generation_time):
    ...
    print(
        f"   Source X range: [{source_coords[:, 0].min()}, {source_coords[:, 0].max()}]"
    )
    print(
        f"   Source Y range: [{source_coords[:, 1].min()}, {source_coords[:, 1].max()}]"
    )
...
def main():
    ...
    print_dataset_summary(
        wave_fields_250, source_coords_250, timesteps_list[0], gen_time_250
    )
    ...
    file_250 = save_dataset_hdf5(
        ...
        timesteps_list[0],
        gen_time_250,
        f"wave_dataset_T{timesteps_list[0]}.h5",
    )
    ...
    print_dataset_summary(
        wave_fields_500, source_coords_500, timesteps_list[1], gen_time_500
    )
    ...
    file_500 = save_dataset_hdf5(
        ...
        timesteps_list[1],
        gen_time_500,
        f"wave_dataset_T{timesteps_list[1]}.h5",
    )
    ...
    print(
        f"   Total generation time: {total_time:.1f} seconds ({total_time/60:.1f} minutes)"
    )
