...
def run_t250_validation():
    ...
    results_dir = Path(
        f"experiments/t250_cv_full/extra_validation/validation_{timestamp}"
    )
    results_dir.mkdir(parents=True, exist_ok=True)

    # Generate comprehensive analysis plots
    create_analysis_plots(
        distance_errors, predictions, ground_truths, results_dir, model_info
    )
...
def create_analysis_plots(
    ...
    fig.suptitle(
        "T=250 Model Extra Validation Analysis", fontsize=16, fontweight="bold"
    )
