...
def create_feature_visualization(sample_id, stage, n_features=9, save_plot=True):
    ...
    fig.suptitle(
        f"Feature Analysis: {sample_id} (Stage {stage})\n"
...
def main():
    ...
    print(
        f"📊 Found {summary['total_samples']} samples with {summary['n_features_per_stage']} features per stage"
    )
    ...
    print("🎯 Creating visualizations for first 3 samples...")
    ...
    print("📁 Check plots in: experiments/feature_analysis/plots/")
